...
// json file
var obj = fs.readFileSync(__dirname+"/data.json");
var jsonObj = JSON.parse(obj);

// templates
var templateProduct = fs
  .readFileSync(__dirname+"/template-product.html")
  .toString();
var templateCards = fs
  .readFileSync(__dirname+"/template-card.html")
  .toString();
var templateOverview = fs
  .readFileSync(__dirname+"/template-overview.html")
  .toString();
